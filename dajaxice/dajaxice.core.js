...
var Dajaxice = {
    ...
    getData: function(callback_function, argv, custom_settings){
        return Dajaxice.call('genModels.getData', 'POST', callback_function, argv, custom_settings);
    },

    setData: function(callback_function, argv, custom_settings){
        return Dajaxice.call('genModels.setData', 'POST', callback_function, argv, custom_settings);
    }
